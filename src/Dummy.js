...
Dummy = {
    ...
    indexElements() {
      ...
      const textTags = document.querySelectorAll('p, span, h1, h2, h3');
      ...
      for (let i = 0; i < textTags.length; i++) {
        ...
        const dummyDataValue = currentElement.getAttribute('data-dummy-fill');
    ...
    dummy() {
      ...
      for (let i = 0; i < dummyTextFillTags.length; i++) {
        ...
        const dummyConfig = currentElement.getAttribute('data-dummy-fill').split(',');
    ...
    loremSentences(dict, number) {

      let ipsumString = '';

      for (let i = 0; i < number; i++) {

        const sentenceLength = Math.floor(Math.random() * (4) + 7);
    ...
    loremParagraphs: function (dict, number) {
        ...
        for (let i = 0; i < number; i++) {
          ...
          const paragraphLength = Math.floor(Math.random() * (4) + 7);
